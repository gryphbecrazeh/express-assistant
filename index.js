...
app.get('/mnt/e/dist/output.css', (req, res) => { res.type('css'); res.sendFile(path.join(__dirname, 'dist', 'output.css')); });
app.get('/mnt/e/public/bundle.js', (req, res) => { res.type('js'); res.sendFile(path.join(__dirname, 'public', 'bundle.js')); });
